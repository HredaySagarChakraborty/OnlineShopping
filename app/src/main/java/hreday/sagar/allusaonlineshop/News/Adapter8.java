...
public class Adapter8 extends RecyclerView.Adapter<Adapter8.ViewHolder> {
   ...
   Context context;
    ...
    public Adapter8(eight eight, List<PojoClass8> list) {
    }

    public Adapter8(Context context, List<PojoClass8> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        PojoClass8 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        Adapter8.clickListener=clickListener;
    }
