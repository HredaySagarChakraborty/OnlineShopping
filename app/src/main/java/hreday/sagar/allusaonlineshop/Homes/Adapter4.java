...
public class Adapter4 extends RecyclerView.Adapter<Adapter4.ViewHolder> {
   ...
   Context context;
    ...
    public Adapter4(four four, List<PojoClass4> list) {
    }

    public Adapter4(Context context, List<PojoClass4> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        PojoClass4 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        Adapter4.clickListener=clickListener;
    }
