...
public class Adapter11 extends RecyclerView.Adapter<Adapter11.ViewHolder> {
   ...
   Context context;
    ...
    public Adapter11(eleven eleven, List<PojoClass11> list) {
    }

    public Adapter11(Context context, List<PojoClass11> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        PojoClass11 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        Adapter11.clickListener=clickListener;
    }
