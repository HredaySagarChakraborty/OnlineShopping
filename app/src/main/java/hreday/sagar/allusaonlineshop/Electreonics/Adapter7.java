...
public class Adapter7 extends RecyclerView.Adapter<Adapter7.ViewHolder> {
   ...
   Context context;
    ...
    public Adapter7(seven seven, List<PojoClass7> list) {
    }

    public Adapter7(Context context, List<PojoClass7> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        PojoClass7 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        Adapter7.clickListener=clickListener;
    }
