...
public class Adapter6 extends RecyclerView.Adapter<Adapter6.ViewHolder> {
   ...
   Context context;
    ...
    public Adapter6(six six, List<PojoClass6> list) {
    }


    public Adapter6(FragmentActivity context, List<PojoClass6> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        PojoClass6 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        Adapter6.clickListener=clickListener;
    }
