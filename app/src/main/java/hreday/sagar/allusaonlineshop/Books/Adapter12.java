...
public class Adapter12 extends RecyclerView.Adapter<Adapter12.ViewHolder> {
   ...
   Context context;
    ...
    public Adapter12(twelve twelve, List<PojoClass12> list) {
    }

    public Adapter12(Context context, List<PojoClass12> list) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        PojoClass12 hh = list.get(position);
    ...
    public  void setOnItemClickListener(ClickListener clickListener){
        ...
        Adapter12.clickListener=clickListener;
    }
